<%@ page language="C#" autoeventwireup="true" inherits="member_WebOt_FT_order_Lm, App_Web_h-elesbu" enableEventValidation="false" %>
...
<head id="Head1" runat="server">
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        function Sum_Money( )
        {//
            var lWin_Money = Sum_Chip_Money("<% Response.Write(mChipCaption); %>","Txt"  )
        ...
        <form id="Form1" name="select_lt" method="post" runat="server" onsubmit="return SubData();">
            ...
            <div class="div_table">
                <table id="TableA" class="Main_Table" cellspacing="1" cellpadding="0" border="0">
                    <thead>
                        <tr>
                            <td class="td_Head_set_cen" colspan="2" style="height: 25px">
                                <asp:Label ID="Label9" runat="server" Text="本場單项最高"></asp:Label>
                                <em>
                                    <asp:Label ID="LabDxA" runat="server"></asp:Label></em>
                    ...
                    <tr>
                        <td class="td_cen_caption" colspan="2">
                            <asp:Label ID="LabCapName" runat="server" Text="AAAA"></asp:Label>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div class="div_sendsub">
                ...
                <input id="WagerTxt" runat="server" name="TxtButData" readonly="readonly" type="text" style="visibility: hidden; width: 3px; display: none;" />
            </div>
