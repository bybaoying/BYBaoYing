<%@ page language="C#" autoeventwireup="true" inherits="member_WebOt_ld_Hews, App_Web_t2vtoice" enableEventValidation="false" %>
...
<head id="Head1" runat="server">
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        {
            location='ld_HewsEd.aspx?GameType=<% =Request.QueryString["GameType"] %>&Classid=<% =Request.QueryString["Classid"] %>'  ;
        }
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="Td_TabPage">
                            <div id="tab">
                                <ul>
                                    <li id="linkZm1" runat="server" class="unTagClick"><a onmousemove="Object_hover(this);" onmouseout="Object_leave(this);" href="javascript:openNewPage('25');">佰拾个</a></li>
                                    <li id="linkZm2" runat="server" class="unTagClick"><a onmousemove="Object_hover(this);" onmouseout="Object_leave(this);" href="javascript:openNewPage('26');">佰拾</a></li>
                                    <li id="linkZm3" runat="server" class="unTagClick"><a onmousemove="Object_hover(this);" onmouseout="Object_leave(this);" href="javascript:openNewPage('27');">佰个</a></li>
                                    <li id="linkZm4" runat="server" class="unTagClick"><a onmousemove="Object_hover(this);" onmouseout="Object_leave(this);" href="javascript:openNewPage('28');">拾个</a></li>
                                        ...
                                        <table id="Table3" class="table_Chip" cellspacing="1" cellpadding="0" border="0">
                                            ...
                                            <tr>
                                                <td class="td_Caption_set">
                                                    最低限额</td>
                                                <td style="width: 146px;" class="td_Center_set">
                                                    <asp:Label ID="LabDd25" runat="server"></asp:Label>
                                                    <asp:Label ID="LabDd26" runat="server"></asp:Label>
                                                    <asp:Label ID="LabDd27" runat="server"></asp:Label>
                                                    <asp:Label ID="LabDd28" runat="server"></asp:Label></td>
                                                <td class="td_Caption_set">
                                                    单注限额</td>
                                                <td class="td_Center_set">
                                                    <asp:Label ID="LabDz25" runat="server"></asp:Label>
                                                    <asp:Label ID="LabDz26" runat="server"></asp:Label>
                                                    <asp:Label ID="LabDz27" runat="server"></asp:Label>
                                                    <asp:Label ID="LabDz28" runat="server"></asp:Label></td>
                                                <td class="td_Caption_set">
                                                    单项限额</td>
                                                <td class="td_Center_set">
                                                    <asp:Label ID="LabDx25" runat="server"></asp:Label>
                                                    <asp:Label ID="LabDx26" runat="server"></asp:Label>
                                                    <asp:Label ID="LabDx27" runat="server"></asp:Label>
                                                    <asp:Label ID="LabDx28" runat="server"></asp:Label></td>
                                            </tr>
                                        </table>
        ...
        <table id="Table10" width="668" class="table_banner" cellspacing="1" style="display: none; visibility: hidden">
            <tr>
                ...
                <td class="ball_td" align="center">
                    单注限额</td>
                <td class="list_cen">
                    <asp:Label ID="LabDc25" runat="server"></asp:Label> 
                    <asp:Label ID="LabDc26" runat="server"></asp:Label>
                    <asp:Label ID="LabDc27" runat="server"></asp:Label>
                    <asp:Label ID="LabDc28" runat="server"></asp:Label>
                    &nbsp;
                </td>
                <td class="ball_td" align="center">
                    单号限额</td>
