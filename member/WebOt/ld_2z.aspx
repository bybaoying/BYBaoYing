<%@ page language="C#" autoeventwireup="true" inherits="member_WebOt_ld_2z, App_Web_t2vtoice" enableEventValidation="false" %>
...
<head id="Head1" runat="server">
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        {
            location="ld_2zEd.aspx?GameType=" + "<% =Request.QueryString["GameType"] %>" + "&Classid=" + "<% =Request.QueryString["Classid"] %>" ;
        }
        ...
        {
            location='ld_2dw.aspx?GameType=<% =Request.QueryString["GameType"] %>&Classid=' + vClassid ;
        }  
        function SendData()
        {
