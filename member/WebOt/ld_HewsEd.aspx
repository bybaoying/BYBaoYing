<%@ page language="C#" autoeventwireup="true" inherits="member_WebOt_ld_HewsEd, App_Web_t2vtoice" enableEventValidation="false" %>
...
<head id="Head1" runat="server">
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        {
            location="ld_Hews.aspx?GameType=" + "<% =Request.QueryString["GameType"] %>" + "&Classid=" + "<% =Request.QueryString["Classid"] %>" ;
        }
                                        ...
                                        <table id="Table1" class="table_Chip" cellspacing="1" cellpadding="0" border="0">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td_Caption_set">
                                                    单注限额</td>
                                                <td class="td_Center_set">
                                                    <asp:Label ID="LabDz25" runat="server"></asp:Label><asp:Label ID="LabDz26" runat="server"></asp:Label><asp:Label ID="LabDz27" runat="server"></asp:Label><asp:Label ID="LabDz28" runat="server"></asp:Label></td>
                                                <td class="td_Caption_set">
                                                    单项限额</td>
                                                <td class="td_Center_set">
                                                    &nbsp;<asp:Label ID="LabDx25" runat="server"></asp:Label><asp:Label ID="LabDx26" runat="server"></asp:Label><asp:Label ID="LabDx27" runat="server"></asp:Label><asp:Label ID="LabDx28"
        ...
        <table id="Table10" width="668" class="table_banner" cellspacing="1" style="display: none; visibility: hidden">
            <tr>
                ...
                <td class="list_cen">
                    ...
                    <asp:Label ID="LabDc28" runat="server"></asp:Label></td>
                <td class="ball_td" align="center">
                    单号限额</td>
                <td class="list_cen">
