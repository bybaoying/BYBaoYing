<%@ page language="c#" inherits="WebTm.history_data_mx, App_Web_01izlwfu" enableEventValidation="false" %>
...
<head>
    ...
    <script language="JavaScript" type="text/javascript" >
            if(self == top) location = '/';
                    ...
                    function ShowPage()
        {
            var chiptype = "<% =Request.QueryString["chiptype"] %>";
            var tmDateNo = "<% =Request.QueryString["tmDateNo"] %>";
            
	        location='?chiptype=' + chiptype + '&tmDateNo=' + tmDateNo +'&Pageid=' + document.getElementById('DDPage').value +"&GameType=<% =Request.QueryString["GameType"] %>" ;
                ...
                <tr>
                    <td class="Td_Table">
                        ...
                        <table id="TableA" class="Main_Table" cellspacing="1" cellpadding="0" runat="server">
                            <tr>
                                <td class="td_title_set_cen" colspan="7">
                                    历史帐户明细</td>
                            </tr>
                            <tr>
