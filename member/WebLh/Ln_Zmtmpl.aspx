<%@ page language="C#" autoeventwireup="true" inherits="member_WebLh_Ln_Zmtmpl, App_Web_xt-ylzzg" enableEventValidation="false" %>
...
<head id="Head1" runat="server">
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        {
            location='ln_zmtm.aspx?Classid=' + "<% =Request.QueryString["Classid"] %>" ;
        }
...
<body onload="onLoad();">
    <form id="Form1" method="post" runat="server">
        <div class="div_windows">
            <table id="Table2" class="table_windows" cellspacing="0" cellpadding="0">
                <tbody>
                    <tr>
                        <td>
                                    ...
                                    <td>
                                        <table id="Table8" class="table_ChipHead" cellspacing="1" cellpadding="0" border="0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <table class="table_ChipInfo" id="Table3" border="0" cellspacing="1" cellpadding="0">
                                                            <tr>
                                                                <td style="width: 150px">
                                                                    <strong>期数:</strong>
                                                                ...
                                                                <td style="width: 250px">
                                                                    ...
                                                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                                    <asp:HyperLink ID="LinkChipKS" runat="server" NavigateUrl="FT_order_Tm.aspx?TmClassid=26"
                                                                        Target="bbnet_mem_order">快速下注</asp:HyperLink></td>
                                                                <td style="text-align: right">
                                                                    <b>开奖日期: </b>
                                        ...
                                        <table id="Table4" class="table_Chip" cellspacing="1" cellpadding="0" border="0">
                                            ...
                                            <tr class="Tr_TmShow">
                                                <td class="Td_TmBallfont" background="../imagesBall/r.gif" id="TD2">
                                            ...
                                            <tr class="Tr_TmShow">
                                                ...
                                                <td class="Td_TmBallfont" background="../imagesBall/b.gif" height="28">
                                                    <font class="ballfont">14</font></td>
                                                <td class="Td_TmPlfont">
                                                    <asp:HyperLink ID="Label14" runat="server">0</asp:HyperLink></td>
                                                <td class="Td_TmBallfont" background="../imagesBall/r.gif" height="28">
                                                ...
                                                <td class="Td_TmBallfont" background="../imagesBall/g.gif" height="28">
