<%@ page language="c#" inherits="WebTm.ln_Zmpl, App_Web_xt-ylzzg" enableEventValidation="false" %>
...
<head id="Head1" runat="server">
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        {
            location='ln_Zm.aspx?Classid=' + "<% =Request.QueryString["Classid"] %>" ;
        }
                                ...
                                <tr>
                                    <td>
                                                        ...
                                                        <table class="table_ChipInfo" id="Table2" border="0" cellspacing="1" cellpadding="0">
                                                            <tr>
                                                                <td style="width: 150px">
                                                                    期数:
                                                                    <asp:Label ID="Labtmwinno" runat="server">Label</asp:Label></td>
                                                                <td style="width: 250px">
                                        ...
                                        <table id="Table6" class="table_Chip" cellspacing="1" cellpadding="0" border="0">
                                            ...
                                            <tr class="Tr_TmShow">
                                                ...
                                                <td class="Td_TmPlfont">
                                                    <asp:HyperLink ID="Label1" runat="server">0</asp:HyperLink></td>
                                            ...
                                            <tr class="Tr_TmShow">
                                                ...
                                                <td class="Td_TmPlfont">
                                                    <asp:HyperLink ID="Label2" runat="server">00</asp:HyperLink>
                                                </td>
                                                <td class="Td_TmBallfont" background="../imagesBall/r.gif">
                                            ...
                                            <tr class="Tr_TmShow">
                                                ...
                                                <td class="Td_TmPlfont">
                                                    <asp:HyperLink ID="Label3" runat="server">00</asp:HyperLink>
                                                </td>
                                                <td class="Td_TmBallfont" background="../imagesBall/r.gif">
                                        ...
                                        <table id="Table4" class="table_Chip" cellspacing="1" cellpadding="0" border="0">
                                            <tr class="Tr_TmShow">
                                                <td class="TmLabfont" width="81">
                                                    总单</td>
                                                <td width="81" class="Td_TmPlfont">
                                                    <asp:HyperLink ID="Labelzhdr" runat="server">00</asp:HyperLink></td>
                                                <td class="TmLabfont" width="81">
                                                    总双</td>
                                                <td width="81" class="Td_TmPlfont">
                                                    <asp:HyperLink ID="Labelzhsa" runat="server">00</asp:HyperLink></td>
                                                <td class="TmLabfont" width="81">
                                                    总大</td>
                                                <td width="81" class="Td_TmPlfont">
                                                    <asp:HyperLink ID="Labelzhda" runat="server">00</asp:HyperLink></td>
                                                <td class="TmLabfont" width="82">
                                                    总小</td>
                                                <td width="82" class="Td_TmPlfont">
                                                    <asp:HyperLink ID="Labelzhxa" runat="server">00</asp:HyperLink></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
