...
//    typeof(window.XMLHttpRequest) 'IE6 返回undefined Firefox 返回function IE8 返回object
//        alert( window.XMLHttpRequest + " " +  typeof(window.XMLHttpRequest)  + (typeof(netscape)!="undefined") );
    if (typeof(netscape)!="undefined")  // firefox
    {        
        try 
        { 
...
function getReady(returnvalue){
    if (returnvalue==null || returnvalue=='r'){
