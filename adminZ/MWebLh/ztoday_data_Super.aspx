<%@ page language="C#" autoeventwireup="true" inherits="adminZ_MWebLh_ztoday_data_Super, App_Web_ruumpoam" enableEventValidation="false" %>
...
<head id="Head1" runat="server">
    ...
    <script language="JavaScript" type="text/javascript">
        function ShowPage()
        {
            location='ztoday_data_Super.aspx?Userid=' + "<% =Request.QueryString["Userid"] %>" +
        ...
        <table class="m_tab" cellspacing="1" cellpadding="0" bgcolor="#000000" border="0" id="TableA" runat="server">
            <tbody>
                <tr class="m_title_reall">
                    <td colspan="11">
                        帐户报表:即时注单--<asp:Label ID="TableTit" runat="server"></asp:Label></td>
                </tr>
                <tr class="m_title_reall">
                    <td width="90">
