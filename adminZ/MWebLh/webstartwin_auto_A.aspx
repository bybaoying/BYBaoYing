<%@ page language="C#" autoeventwireup="true" inherits="adminZ_MWebLh_webstartwin_auto_A, App_Web_wtmgu-sw" enableEventValidation="false" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        mGetHttpArr[0][1]  = "http://kaijiang.zhcw.com/kaijiang/zhcw_3d_index.html"// 福彩3D
//        mGetHttpArr[0][1]  = "http://localhost/zhcw_3d_index.html" ;
...
//            mHttpGetText=mGetHttpArr[i][4];
            ...
            oDiv.innerHTML = "";
            PostCall(mHttpUrl,mHttpValue);
//            GetCall(mHttpUrl,mHttpValue); 
