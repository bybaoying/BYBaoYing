<%@ page language="C#" autoeventwireup="true" inherits="adminZ_Mapp_WLoginZ, App_Web_i89w4dwr" culture="auto" uiculture="auto" meta:resourcekey="PageResource1" enableEventValidation="false" %>
                    ...
                    <div>
                        <span class="login_font_6">
                            ...
                            <asp:Label ID="Labelc" runat="server" Text='<%$ resources:Resource, Label3Msg %>'
                                meta:resourcekey="LabelcResource1">
                            </asp:Label>
