                    ...
                    <form id="form1" onsubmit="return chk_acc();" runat="server">
                        <table border="0" cellpadding="1" cellspacing="1">
                            ...
                            <tr>
                                <td>
                                    <p>
                                        <asp:Label ID="Label2" runat="server" meta:resourcekey="Label2Resource1" Text="帐    号:" Width="40px"></asp:Label>
                                    </p>
                                </td>
                                <td>
                                    &nbsp;<input id="TxtUsername" runat="server" class="input_1" maxlength="20" meta:resourcekey="usernameResource1" name="TxtUsername" size="15" style="width: 90px" title="请输入帐号!!" type="text"
                                        tabindex="1" /></td>
                                <td colspan="2">
                            ...
                            <tr>
                                ...
                                <td style="width: 120px">
                                    &nbsp;<input id="TxtPassword" runat="server" class="input_1" maxlength="20" meta:resourcekey="passwdResource1" name="TxtPassword" style="width: 90px" title="请输入密码!!" type="password"
                                        tabindex="1" /></td>
                                <td style="width: 90px">
                                    <input id="number" runat="server" class="input_1" maxlength="20" meta:resourcekey="numberResource1" style="width: 70px" title="请输入检查码!!" type="text" tabindex="2" />
                                </td>
                                <td>
                                    <asp:Button ID="CmdLongin" runat="server" Height="22px" meta:resourcekey="CmdLonginResource1" OnClick="CmdLongin_Click" Text="确定" Width="45px" TabIndex="4" />
                                </td>
                            </tr>
                        </table>
                    </form>
