<%@ page language="C#" autoeventwireup="true" inherits="adminZ_Mapp_WebUpdateNet, App_Web_i89w4dwr" enableEventValidation="false" %>
            ...
            <div id="main">
                <ul>
                    ...
                    <li>至
                        ...
                        <script>document.write(getQueryStringValue("UpdateTime"));</script>

                        点更新完成</li>
                </ul>
                <div id="show">
                    <p id="help">
                        <a>Cust.Service 服务中心</a></p>
                    <marquee id="helpor_net" onmouseover="this.setAttribute('scrollamount', 0, 0);" onmouseout="this.setAttribute('scrollamount', 6, 0);"><% = Request.QueryString["Message"]%></marquee>
                    <div class="ps">
                        System is being renovated</div>
                </div>
            </div>
        </div>
    </form>
