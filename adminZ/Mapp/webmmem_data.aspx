<%@ page language="C#" autoeventwireup="true" inherits="adminZ_Mapp_webmmem_data, App_Web_i89w4dwr" enableEventValidation="false" %>
...
<head runat="server">
    ...
    //        alert(document.getElementById("TableA").Rows.Count);
                var vAValue = 0 ;
...
<body text="#000000" vlink="#0000ff" alink="#0000ff" bgcolor="#ffffff" leftmargin="0"
    topmargin="0" onload="PageLoad();">
    <form id="form1" runat="server">
        <table class="title_m_tab" cellspacing="0" cellpadding="0" border="0">
            <tbody>
                <tr class="td_banner_b">
                    <td>
                    </td>
                </tr>
                <tr class="td_banner_m">
                    <td>
                        &nbsp;&nbsp;会员详细设定&nbsp;&nbsp;&nbsp;帐号:<asp:Label ID="TxtAdminId" runat="server"
                            Height="12px" Visible="False"></asp:Label>
                        <asp:Label ID="TxtUsername" runat="server" Height="12px"></asp:Label>-- 会员名称:
                        <asp:Label ID="TxtUserId" runat="server"></asp:Label>--信用额度:
                        <asp:Label ID="xynd" runat="server"></asp:Label>--盘别:
                        <asp:Label ID="LabUserLevel" runat="server"></asp:Label>-- <a href="WebUser.aspx">回上一页</a>
                    </td>
                </tr>
                <tr class="td_banner_b">
                    <td>
        ...
        <table id="TabSysType" runat="server">
            <tr>
                ...
                <td id="TdClickTM" runat="server">
                    <a id="ClickTM" class="m_ClickType_Close" href="javascript:HrefType('','SysType=TM')">
                        [主盤]</a>
                </td>
                <td id="AdminLevel1A">
                    |
                ...
                <td id="TdClickD3" runat="server">
                    <a id="ClickD3" class="m_ClickType_Close" href="javascript:HrefType('','SysType=D3')">
                        [福彩]</a>
                </td>
                <td id="AdminLevel2A">
                    |
                ...
                <td id="TdClickP3" runat="server">
                    <a id="ClickP3" class="m_ClickType_Close" href="javascript:HrefType('','SysType=P3')">
                        [體彩]</a>
                </td>
            </tr>
        </table>
        <table class="m_tab_ed" cellspacing="1" cellpadding="0" border="0" id="TableA" runat="server">
            <tbody>
                ...
                <tr class="mem_index_cen">
                    <td align="middle" bgcolor="#ffffff" colspan="23">
                        <asp:Button ID="ButData" runat="server" OnClick="ButData_Click" Text="确定" Width="40px"
                            OnClientClick="return FsValueCheck();" />
                        &nbsp; &nbsp;&nbsp; &nbsp;
                        <asp:Button ID="ButValue" runat="server" OnClick="ButValue_Click" Text="恢复默认值" />&nbsp;
                        &nbsp;&nbsp; &nbsp;
                        <input class="za_button" id="Button1" onclick="document.location='WebUser.aspx'"
                            type="button" value="取消" name="FormsButton2">
                    </td>
                </tr>
            </tbody>
        </table>
