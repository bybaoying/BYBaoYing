<%@ page language="C#" autoeventwireup="true" inherits="adminZ_WebOter_Pl1dw, App_Web_nwkt-b7n" enableEventValidation="false" %>
    ...
    <form id="form1" runat="server">
        <table class="title_m_tab" cellspacing="0" cellpadding="0" border="0">
            ...
            <tr class="mem_index_ctrl_Title">
                <td>
                    &nbsp;&nbsp;一定位&nbsp;&nbsp;-- 香港时间:<asp:Label ID="LabNowDate" runat="server"></asp:Label>
                    -- [<a id="page1" href="javascript:ChageClassid('11')" runat="server">佰定位 </a>] -- [<a id="page2" href="javascript:ChageClassid('12')" runat="server">拾定位</a>] -- [<a id="page3" href="javascript:ChageClassid('13')"
                        runat="server">个定位</a>] --
