<%@ page language="C#" autoeventwireup="true" inherits="adminZ_WebOter_WebSetup_PlKd, App_Web_nwkt-b7n" enableEventValidation="false" %>
    ...
    <form id="form1" runat="server">
        <table class="title_m_tab" cellspacing="0" cellpadding="0" border="0">
            ...
            <tr class="mem_index_ctrl_Title">
                <td>
                    &nbsp;&nbsp;跨度&nbsp;&nbsp;-- 香港时间:<asp:Label ID="LabNowDate" runat="server"></asp:Label></td>
            </tr>
        </table>
