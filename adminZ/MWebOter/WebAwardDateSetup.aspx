<%@ page language="C#" autoeventwireup="true" inherits="adminZ_WebOter_WebAwardDateSetup, App_Web_hmaezzcm" enableEventValidation="false" %>
        ...
        <table id="Table1" class="m_tab_ed">
            <tr>
                <td class="m_title_edit" colspan="4">
                    <asp:Label ID="LabGameCaption" runat="server"></asp:Label>-开奖日期预设置
                </td>
            </tr>
            <tr class="m_bc_ed">
            ...
            <tr class="m_bc_ed">
                ...
                <td colspan="3" style="height: 25px">
                    <asp:TextBox ID="Ttmwinstart" runat="server" name="Ttmwinstart" Width="101px"></asp:TextBox><asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="../images/calendar.gif" OnClientClick="calendar(document.getElementById('Ttmwinstart'),event);return false;" />开盘时间：
            ...
            <tr class="m_bc_ed">
                <td colspan="3" style="height: 25px">
                    <span style="font-family: Arial; background-color: #f2faff"></span>
                    <asp:TextBox ID="Ttmwinend" runat="server" name="Ttmwinend" Width="101px"></asp:TextBox><asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="../images/calendar.gif" OnClientClick="calendar(document.getElementById('Ttmwinend'),event);return false;" />封盘时间：
