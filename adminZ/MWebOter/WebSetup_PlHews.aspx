<%@ page language="C#" autoeventwireup="true" inherits="adminZ_MWebOter_WebSetup_PlHews, App_Web_nwkt-b7n" enableEventValidation="false" %>
    ...
    <form id="form1" runat="server">
        <table class="title_m_tab" cellspacing="0" cellpadding="0" border="0">
            ...
            <tr class="mem_index_ctrl_Title">
                <td>
                    &nbsp;&nbsp;和尾数&nbsp;&nbsp;-- 香港时间:<asp:Label ID="LabNowDate" runat="server"></asp:Label>
                    -- [<a id="page1" href="javascript:ChageClassid('25')" runat="server">佰拾个 </a>]
                     -- [<a id="page2" href="javascript:ChageClassid('26')" runat="server">佰拾</a>]
                      -- [<a id="page3" href="javascript:ChageClassid('27')" runat="server">佰个</a>]
                      -- [<a id="page4" href="javascript:ChageClassid('28')" runat="server">拾个</a>]
                        ...
                        <table cellspacing="0" cellpadding="0" width="100%" border="0" id="TSetupPl" runat="server">
                            <tr>
                                ...
                                <td bgcolor="#ffffcc" colspan="2" style="height: 24px; width: 96px;">
                                    <input type="submit" name="Submit" value="确定" id="SubTmpl" runat="server" onclick="return SubData();" onserverclick="ButOk_Click" /><input type="reset" name="Submit2" value="清除" /></td>
                            </tr>
                            <tr>
                                <td bgcolor="#FFFFCC" style="width: 105px">
                                    赔率
